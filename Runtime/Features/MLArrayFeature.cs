...
namespace NatSuite.ML.Features {
    ...
    /// ML array feature.
    /// </summary>
    public sealed unsafe class MLArrayFeature<T> : MLFeature, IMLEdgeFeature, IMLHubFeature where T : unmanaged {
        ...
        /// </summary>
        /// <param name="feature">Hub feature. This MUST be an array feature.</param>
        public MLArrayFeature (MLHubFeature feature) : this(FeatureData(feature), feature.shape) { }

        [Obsolete(@"Deprecated in NatML 1.0.9. Use `MLEdgeFeature` constructor instead.", false)]
        public unsafe MLArrayFeature (IntPtr feature) : this(new MLEdgeFeature(feature)) { }
        #endregion
        ...
        private static readonly string[] HubTypes = new [] {
            HubDataType.Float32, HubDataType.Float64,
            HubDataType.Int8, HubDataType.Int16, HubDataType.Int32, HubDataType.Int64,
            HubDataType.UInt8, HubDataType.UInt16, HubDataType.UInt32, HubDataType.UInt64,
        };
        ...
        unsafe MLEdgeFeature IMLEdgeFeature.Create (in MLFeatureType type) {
            ...
            if (featureType.dataType != arrayType.dataType)
                throw new ArgumentException($"Cannot create {featureType.dataType} feature with {arrayType.dataType} feature");
            ...
            fixed (T* managedData = array) {
                ...
                NatML.CreateFeature(
                    ...
                    data == managedData ? NatML.FeatureFlags.CopyTensorData : 0,
                    out var feature
                );
