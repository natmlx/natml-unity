...
namespace NatSuite.ML.Features {
    ...
    public sealed unsafe class MLArrayFeature<T> : MLFeature, IMLFeature where T : unmanaged {
        ...
        /// <returns></returns>
        internal unsafe MLArrayFeature<T> Flatten (int startDim = 0, int endDim = -1) { // INCOMPLETE
            return default;
        }
        ...
        /// </summary>
        /// <returns></returns>
        internal unsafe MLArrayFeature<float> Float () => To<float>(); // INCOMPLETE // DOC

        /// <summary>
        /// </summary>
        /// <returns></returns>
        internal unsafe MLArrayFeature<int> Int () => To<int>(); // INCOMPLETE // DOC
        ...
        /// <returns></returns>
        internal unsafe MLArrayFeature<T> Squeeze (int dim = -1) { // INCOMPLETE
            return default;
        }
        ...
        /// <returns></returns>
        internal unsafe MLArrayFeature<U> To<U> () where U : unmanaged { // INCOMPLETE
            return default;
        }
        #endregion
        ...
        /// <returns></returns>
        internal unsafe MLArrayFeature<T> Argmax (int dim = -1, bool keepDim = false) { // INCOMPLETE
            return default;
        }
        ...
        /// <param name="keepDim"></param>
        /// <returns></returns>
        internal unsafe MLArrayFeature<T> Argmin (int dim = -1, bool keepDim = false) { // INCOMPLETE
            return default;
        }
        ...
        /// </summary>
        /// <returns></returns>
        internal unsafe MLArrayFeature<float> Exp () { // INCOMPLETE
            return default;
        }
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        internal unsafe MLArrayFeature<T> Dot (MLArrayFeature<T> input) { // INCOMPLETE
            return default;
        }
        ...
        /// <param name="keepDim"></param>
        /// <returns></returns>
        internal unsafe MLArrayFeature<float> Softmax (int dim = -1, bool keepDim = false) { // INCOMPLETE
            return default;
        }
        ...
        /// <param name="keepDim"></param>
        /// <returns></returns>
        internal unsafe MLArrayFeature<T> Sum (int dim = -1, bool keepDim = false) { // INCOMPLETE
            return default;
        }
        #endregion
        ...
        public static MLArrayFeature<T> operator - (MLArrayFeature<T> x) { // INCOMPLETE
            return default;
        }

        public static MLArrayFeature<float> operator + (MLArrayFeature<T> a, float b) { // INCOMPLETE
            return default;
        }
        ...
        public static MLArrayFeature<float> operator - (float a, MLArrayFeature<T> b) { // INCOMPLETE
            return default;
        }
