...
namespace NatML.Internal {
    ...
    public static class NatML { // NatML.h
        ...
        public static unsafe extern void CreateModelOptions (out IntPtr options);
        [DllImport(Assembly, EntryPoint = @"NMLReleaseModelOptions")]
        public static unsafe extern void ReleaseModelOptions (this IntPtr options);
        [DllImport(Assembly, EntryPoint = @"NMLModelOptionsSetHubSessionFlags")]
        public static unsafe extern void SetHubSessionFlags (this IntPtr options, int flags);
        [DllImport(Assembly, EntryPoint = @"NMLModelOptionsSetComputeTarget")]
        public static unsafe extern void SetComputeTarget (this IntPtr options, MLModelData.ComputeTarget target);
        [DllImport(Assembly, EntryPoint = @"NMLModelOptionsSetComputeDevice")]
        public static unsafe extern void SetComputeDevice (this IntPtr options, IntPtr device);
        #endregion
        ...
        [DllImport(Assembly, EntryPoint = @"NMLImageFeatureRegionOfInterest")]
        public static unsafe extern void RegionOfInterest (
            void* pixelBuffer,
            int width,
            int height,
            int* rect,
