...
namespace NatSuite.ML.Types {
    ...
    public class MLVideoType : MLImageType {
        ...
        /// Video width.
        /// </summary>
        public override int width => shape[interleaved ? 3 : 4];

        /// <summary>
        /// Video height.
        /// </summary>
        public override int height => shape[interleaved ? 2 : 3];

        /// <summary>
        /// Video channels.
        /// </summary>
        public override int channels => shape[interleaved ? 4 : 2];
        ...
        public MLVideoType (int[] shape, Type type, string name = null) : base(shape, type, name) => this.interleaved = shape[2] > shape[4];
        ...
        public static MLVideoType FromVideoClip (VideoClip clip) => new MLVideoType(
            new [] { 1, (int)clip.frameCount, (int)clip.height, (int)clip.width, 4 },
            typeof(byte),
            clip.name
        );
