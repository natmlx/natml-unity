...
namespace NatSuite.ML.Types {
    ...
    public class MLImageType : MLArrayType {
        ...
        /// Image width.
        /// </summary>
        public virtual int width => shape[interleaved ? 2 : 3];

        /// <summary>
        /// Image height.
        /// </summary>
        public virtual int height => shape[interleaved ? 1 : 2];

        /// <summary>
        /// Image channels.
        /// </summary>
        public virtual int channels => shape[interleaved ? 3 : 1];
        ...
        public MLImageType (int width, int height, int channels = 3) : this(width, height, channels, typeof(byte)) { }

        /// <summary>
        /// Create an image feature type.
        /// This constructor assumes interleaved RGB888 pixel buffers.
        /// </summary>
        /// <param name="width">Image width.</param>
        /// <param name="height">Image height.</param>
        /// <param name="type">Image data type.</param>
        public MLImageType (int width, int height, Type type) : this(width, height, 3, type) { }
        ...
        public MLImageType (int[] shape, Type type, string name = null) : base(shape, type, name) => this.interleaved = shape[1] > shape[3];
