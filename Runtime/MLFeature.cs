...
namespace NatML {
    ...
    using CloudDataType = Hub.DataType;
    ...
    public abstract class MLFeature {
        ...
        protected static string CloudType (Type type) {
            switch (type) {
                case var t when t == typeof(float):     return CloudDataType.Float32;
                case var t when t == typeof(double):    return CloudDataType.Float64;
                case var t when t == typeof(sbyte):     return CloudDataType.Int8;
                case var t when t == typeof(short):     return CloudDataType.Int16;
                case var t when t == typeof(int):       return CloudDataType.Int32;
                case var t when t == typeof(long):      return CloudDataType.Int64;
                case var t when t == typeof(byte):      return CloudDataType.UInt8;
                case var t when t == typeof(ushort):    return CloudDataType.UInt16;
                case var t when t == typeof(uint):      return CloudDataType.UInt32;
                case var t when t == typeof(ulong):     return CloudDataType.UInt64;
                default:                                return null;
            }
        }
        #endregion
