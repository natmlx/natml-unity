...
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo("NatSuite.ML.Tests")]
namespace NatSuite.ML {
    ...
    public sealed class MLModelData : ScriptableObject {
        ...
        public static async Task<MLModelData> FromHub (string tag, string accessKey = null) {
            ...
            var session = await NatMLHub.CreateSession(input, accessKey ?? NatMLSettings.Settings?.AccessKey);
            // Fetch graph
            byte[] graph = null;
        ...
        private static async Task<MLModelData> FromCache (string tag) {
            ...
            var predictorPath = Path.Combine(CachePath, $"{cacheName}.nml");
