...
/*!
 ...
 Output frame count.
*/
BRIDGE EXPORT void APIENTRY NMLFeatureReaderGetVideoFormat (
    const char* path,
    int32_t* outWidth,
    int32_t* outHeight,
    int32_t* outFrames
...
*/
BRIDGE EXPORT void APIENTRY NMLFeatureReaderGetAudioFormat (
    const char* path,
...
/*!
 ...
 Reader to release.
*/
BRIDGE EXPORT void APIENTRY NMLReleaseFeatureReader (NMLFeatureReader* reader);
...
/*!
 ...
 Output feature.
*/
BRIDGE EXPORT void APIENTRY NMLFeatureReaderReadNextFeature (
...
/*!
 ...
 @param reader
 Output feature reader.
*/
BRIDGE EXPORT void APIENTRY NMLCreateImageFeatureReader (
    const char* path,
    NMLFeatureReader** reader
);
...
/*!
 ...
 Output feature reader.
*/
BRIDGE EXPORT void APIENTRY NMLCreateAudioFeatureReader (
    const char* path,
    NMLFeatureReader** reader
);
#pragma endregion