...
/*!
 @function NMLModelOptionsSetFlags

 @abstract Set predictor session flags.

 @discussion Set predictor session flags.

 @param options
 ML model options.

 @param flags
 Predictor session flags.
*/
NML_BRIDGE NML_EXPORT void NML_API NMLModelOptionsSetFlags (
    NMLModelOptions* options,
    int32_t flags
);
