...
#pragma region --MLImageFeature--
/*!
 @function NMLImageFeatureRegionOfInterest

 @abstract Extract a region of interest from a given image feature.

 @discussion Extract a region of interest from a given image feature.
 The source and destination pixel buffers MUST have an RGBA8888 layout (32 bits per pixel).
 ...
 @param rect
 Region of interest rectangle in pixel coordinates. This must have format (cx,cy,w,h).
 ...
 @param dstBuffer
 Destination pixel buffer. This MUST be large enough to hold the enough pixel data for the given rectangle size.
*/
BRIDGE EXPORT void APIENTRY NMLImageFeatureRegionOfInterest (
