...
/*!
 ...
 @constant NML_FEATURE_FLAG_IMAGE_ASPECT_SCALE
 Image feature is scaled to fit feature size.

 @constant NML_FEATURE_FLAG_IMAGE_ASPECT_FILL
 Image feature is aspect-filled to the feature size.

 @constant NML_FEATURE_FLAG_IMAGE_ASPECT_FIT
 Image feature is aspect-fit to the feature size.

 @constant NML_FEATURE_FLAG_COPY_TENSOR_DATA
 Copy input tensor data when creating feature. This implies `NML_FLAG_DEALLOCATE_TENSOR_DATA`.

 @constant NML_FEATURE_FLAG_DEALLOCATE_TENSOR_DATA
 Deallocate tensor data when the feature is released.
 This requires tensor data to have been allocated with `malloc`.
*/
enum NMLFeatureFlags {
    NML_FEATURE_FLAG_NONE                   = 0,
    // MLImageFeature::AspectMode
    NML_FEATURE_FLAG_IMAGE_ASPECT_SCALE     = 0,
    NML_FEATURE_FLAG_IMAGE_ASPECT_FILL      = 1,
    NML_FEATURE_FLAG_IMAGE_ASPECT_FIT       = 2,
    // MLTensor
    NML_FEATURE_FLAG_COPY_TENSOR_DATA       = 1 << 29,
    NML_FEATURE_FLAG_DEALLOCATE_TENSOR_DATA = 1 << 30
};
