...
namespace NatML.Editor {
    ...
    internal static class NatMLMenu {
        ...
        [MenuItem(@"NatML/NatML " + NatMLSettings.Version, false, BasePriority)]
        private static void Version () { }

        [MenuItem(@"NatML/NatML " + NatMLSettings.Version, true, BasePriority)]
        ...
        private static void ClearCache () => MLModelData.ClearCache();
    }
}
