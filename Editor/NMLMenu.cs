...
namespace NatSuite.ML.Editor {
    ...
    internal static class NMLMenu { // CHECK // Version
        ...
        [MenuItem(@"NatML/NatML 1.0.5")]
        private static void Version () { }

        [MenuItem(@"NatML/NatML 1.0.5", true)]
        ...
        private static void OpenCatalog () => Help.BrowseURL(@"https://hub.natml.ai");
        ...
        private static void OpenDocs () => Help.BrowseURL(@"https://docs.natml.ai");
    }
}